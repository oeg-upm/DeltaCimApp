...
public class JwtTokenUtil implements Serializable {
	...
	private static final String SECRET ="The bird fights its way out of the egg. The egg is the world. Who would be born must first destroy a world. The bird flies to God. That God's name is Abraxas.";
	...
	public String generateToken(String username) {
		return buildToken(username,JWT_TOKEN_VALIDITY_DEFAULT);
	}
	...
	public Cookie createInvalidTokenCookie() {
